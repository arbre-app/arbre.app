...
// Borrowed from https://raw.githubusercontent.com/ekwonye-richard/react-flags-select/master/flags/fr.svg

export function Fr({ ...other }) {
  return (
    <svg viewBox="0 0 512 336" xmlns="http://www.w3.org/2000/svg" {...other}>
      <g fill="none">
